...
SharrrePlatform.register("delicious", function (a) {
	return (
		...
		(defaultSettings = $.extend(!0, {}, defaultSettings, a)),
		{
			...
			popup: function (a) {
				window.open(
					"https://www.delicious.com/save?v=5&noui&jump=close&url=" + encodeURIComponent("" !== this.settings.url ? this.settings.url : a.url) + "&title=" + a.text,
					"delicious",
		...
		return (
			...
			(defaultSettings = $.extend(!0, {}, defaultSettings, a)),
			{
				...
				load: function (a) {
					...
					$(a.element)
						.find(".buttons")
						.append('<div class="button digg"><a class="DiggThisButton ' + b.type + '" rel="nofollow external" href="http://digg.com/submit?url=' + encodeURIComponent("" !== b.url ? b.url : a.options.url) + '"></a></div>')
					var c = 0
				...
				popup: function (a) {
					window.open(
						"http://digg.com/tools/diggthis/submit?url=" + encodeURIComponent("" !== a.buttons.digg.url ? a.buttons.digg.url : a.url) + "&title=" + a.text + "&related=true&style=true",
						"",
	...
	SharrrePlatform.register("facebook", function (a) {
		return (
			(defaultSettings = {url: "", urlCount: !1, action: "like", layout: "button_count", count: !0, width: "", send: "false", faces: "false", colorscheme: "", font: "", lang: "en_US", share: "", appId: "", popup: {width: 900, height: 500}}),
			(defaultSettings = $.extend(!0, {}, defaultSettings, a)),
			{
				settings: defaultSettings,
				url: function (a) {
				...
				popup: function (a) {
					window.open(
						"https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent("" !== this.settings.url ? this.settings.url : a.url) + "&t=" + a.text,
						"",
						"toolbar=0, status=0, width=" + this.settings.popup.width + ", height=" + this.settings.popup.height
					)
				},
		...
		return (
			...
			(defaultSettings = $.extend(!0, {}, defaultSettings, a)),
			{
				...
				load: function (a) {
					...
					$(a.element)
						.find(".buttons")
						.append('<div class="button googleplus"><div class="g-plusone" data-size="' + b.size + '" data-href="' + ("" !== b.url ? b.url : a.options.url) + '" data-annotation="' + b.annotation + '"></div></div>'),
						(window.___gcfg = {lang: b.lang})
					var c = 0
					;("undefined" != typeof gapi && "undefined" != typeof gapi.plusone) || 0 != c
						? gapi.plusone.go()
						: ((c = 1),
						  (function () {
								var a = document.createElement("script")
				...
				popup: function (a) {
					window.open(
						"https://plus.google.com/share?hl=" + this.settings.lang + "&url=" + encodeURIComponent("" !== this.settings.url ? this.settings.url : a.url),
						"",
						"toolbar=0, status=0, width=" + this.settings.popup.width + ", height=" + this.settings.popup.height
					)
				},
		...
		return (
			...
			(defaultSettings = $.extend(!0, {}, defaultSettings, a)),
			{
				...
				load: function (a) {
					...
					$(a.element)
						.find(".buttons")
						.append('<div class="button linkedin"><script type="IN/share" data-url="' + ("" !== b.url ? b.url : a.options.url) + '" data-counter="' + b.counter + '"></script></div>')
					var c = 0
				...
				popup: function (a) {
					window.open(
						"https://www.linkedin.com/cws/share?url=" + encodeURIComponent("" !== this.settings.url ? this.settings.url : a.url) + "&token=&isFramed=true",
						"linkedin",
						"toolbar=no, width=" + this.settings.popup.width + ", height=" + this.settings.popup.height
					)
				},
	...
	SharrrePlatform.register("pinterest", function (a) {
		return (
			...
			(defaultSettings = $.extend(!0, {}, defaultSettings, a)),
			{
				...
				popup: function (a) {
					window.open(
						"https://pinterest.com/pin/create/button/?url=" + encodeURIComponent("" !== this.settings.url ? this.settings.url : a.url) + "&media=" + encodeURIComponent(this.settings.media) + "&description=" + this.settings.description,
						"pinterest",
						"toolbar=no,width=" + this.settings.popup.width + ", height=" + this.settings.popup.height
					)
				},
			...
			(defaultSettings = $.extend(!0, {}, defaultSettings, a)),
			{
				...
				load: function (a) {
					...
					$(a.element)
						.find(".buttons")
						.append(
							'<div class="button reddit"><a href="https://www.reddit.com/submit?url=' + ("" !== b.url ? b.url : a.options.url) + '"><img src="https://www.redditstatic.com/spreddit7.gif" alt="submit to reddit" border="0" /></a></div>'
						),
						$(a.element)
							.find(".reddit")
							.on("click", function () {
		...
		return (
			...
			(defaultSettings = $.extend(!0, {}, defaultSettings, a)),
			{
				...
				load: function (a) {
					...
					$(a.element)
						.find(".buttons")
						.append('<div class="button stumbleupon"><su:badge layout="' + b.layout + '" location="' + ("" !== b.url ? b.url : a.options.url) + '"></su:badge></div>')
					var c = 0
				...
				popup: function (a) {
					window.open(
						"https://www.stumbleupon.com/badge/?url=" + encodeURIComponent("" !== this.settings.url ? this.settings.url : a.url),
						"stumbleupon",
						"toolbar=no, width=" + this.settings.popup.width + ", height=" + this.settings.popup.height
					)
				},
				...
				popup: function (a) {
					window.open(
						"https://www.tumblr.com/share/link?canonicalUrl=" +
							encodeURIComponent("" !== this.settings.url ? this.settings.url : a.url) +
							"&name=" +
	...
	SharrrePlatform.register("twitter", function (a) {
		return (
			...
			(defaultSettings = $.extend(!0, {}, defaultSettings, a)),
			{
				...
				popup: function (a) {
					window.open(
						"https://twitter.com/intent/tweet?text=" + encodeURIComponent(a.text) + "&url=" + encodeURIComponent("" !== this.settings.url ? this.setting.url : a.url) + ("" !== this.settings.via ? "&via=" + this.settings.via : ""),
						"",
						"toolbar=0, status=0,width=" + this.settings.popup.width + ", height=" + this.settings.popup.height
					)
				},
