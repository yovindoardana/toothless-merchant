         ...
         <div class="collapse navbar-collapse justify-content-end" id="navigation">
          <div class="btn-group">
            ...
            <div class="dropdown-menu bg-transparent">
              <a href="" class="btn">Transaction History</a>
     ...
     <div id="carouselExampleInterval" class="carousel slide container" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="10000">
            <img src={{ asset('assets/img/profile-page.png') }} class="d-block w-100" alt="...">
      ...
      <div class="container col-2 mt-3">
        ...
        <div class="card border-0 shadow">
            <img src={{ asset('assets/img/cercuri.png') }} class="img" alt="..." height="200px">
            <div class="card-body">
                <h5 class="card-title"></h5>
                <a href="/user/ml" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Detail
                </a>
            </div>
        </div>
